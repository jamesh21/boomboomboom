...
Flame.prototype.update = function () {
    ...
    for (var i = 0; i < this.game.entities.length; i++) {
        ...
        if (ent !== this && this.collide(ent)) {
            if (ent.name !== "Background" && ent.name !== "star" && !ent.removeFromWorld) {
                this.stop = true;
            }
